...
\begin{algorithmic}
\Procedure{Vyplň}{vstup: reprezentace vnější hranice $vnějšíHraniceStdRep$, velikosti povolených stran $stěny$, $limit$}
...
\State $přechody \gets \emptyset$ 		
 \While {$přechody$.Počet $\leq limit$}
